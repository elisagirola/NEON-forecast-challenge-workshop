...
Learn more about the Challenge [here](https://projects.ecoforecast.org/neon4cast-docs/)!
...
Sign up [here.](https://projects.ecoforecast.org/neon4cast-docs/Participation.html).
...
Find more information about the aquatics challenge [here](https://projects.ecoforecast.org/neon4cast-docs/Aquatics.html).

## Submission requirements

For the Challange, forecasts must include quantified uncertainty.
...
Information on the NEON sites can be found in the `NEON_Field_Site_Metadata_20220412.csv` file on GitHub.
...
We ask that you complete this [form](https://nd.qualtrics.com/jfe/form/SV_9MJ29y2xNrBOjqZ) which asks you some simple questions about your forecast and team.
